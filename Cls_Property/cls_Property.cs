...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        #region Pre constructions methods
        ...
        public int InsertDreamHouseImage(int DreamHouseId, string filename)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "Insert into [tbl_DreamHouseImages](DreamHouseId,ImageUrl) values(@DreamHouseId,@ImageUrl)";
        ...
        public DataTable GetDreamHouseForSlider(int DreamHouseId)
        {
            ...
            try
            {
                ...
                string str = "select * from tbl_DreamHouseImages where DreamHouseId=" + DreamHouseId;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
        ...
        public DataTable GetDreamHouseDetail(int DreamHouseId)
        {
            ...
            try
            {
                ...
                string str = "select * from tbl_DreamHouse where Id=" + DreamHouseId;
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                //dt.TableName = "tbl_Virtual";
            }
