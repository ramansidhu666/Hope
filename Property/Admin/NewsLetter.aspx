                        ...
                        <div style="float: left; width: 99%; background-color: #231f20; border-bottom: 8px solid #eda320; padding: 6px 0;">
                            ...
                            <div style="float: left; width: 67%; padding: 6px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0 0;">
                                    <h2 style="float: left; width: 100%; font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #FFF; margin: 0px;">Hope (Hoi) Nguyen</h2>
                                    ...
                                    <p style="float: left; width: 100%; margin: 0">
                                        ...
                                        <span style="float: left; font-size: 14px; color: #FFF; margin: 0 10px 0 4px;">416-731-7671</span>
                                        <span style="float: left; font-size: 15px; color: #c48820; margin: 0 6px 0 1px">Email:</span>
                                        <span style="float: left; font-size: 14px; color: #FFF;">hnguyen3960@yahoo.ca</span>
                                    </p>
                                    <p style="float: left; width: 100%; margin: 0">
                                        <span style="float: left; font-size: 15px; color: #c48820;">Address:</span>
                                        <span style="float: left; font-size: 14px; color: #FFF; margin: 0 10px 0 4px;">5010 Steeles Ave. West #11A, Toronto, M9V2B8</span>
                                    </p>
